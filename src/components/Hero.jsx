...
const Hero = () => {
  ...
  return (
    <section id="hero" className="pt-16 md:pt-20 min-h-screen flex items-center relative overflow-hidden">
      ...
      {/* Animated Orbs */}
      <div className="absolute top-20 left-10 w-96 h-96 bg-primary-500/20 rounded-full blur-[120px] animate-pulse"></div>
      <div className="absolute bottom-20 -right-20 w-[500px] h-[500px] bg-accent-500/20 rounded-full blur-[150px] animate-pulse" style={{animationDelay: '1s'}}></div>
      <div className="absolute top-1/3 right-1/4 w-80 h-80 bg-gaming-500/15 rounded-full blur-[100px] animate-pulse" style={{animationDelay: '2s'}}></div>
      {/* Grid Pattern */}
